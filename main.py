...
def load_episode(url):
    with quit_web(webdriver.Firefox()) as driver:
        ...
        WebDriverWait(driver, 40).until(visibility_of_element_located((By.ID, "afterLoad")))
        proceed = driver.find_element_by_id("proceed")
        proceed.click()

        WebDriverWait(driver, 5).until(visibility_of_element_located((By.ID, "videojs_html5_api")))
